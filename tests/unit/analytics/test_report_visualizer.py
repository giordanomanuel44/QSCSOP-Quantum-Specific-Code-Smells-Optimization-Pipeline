...
_FULL_METRICS = {
    ...
    "long_circuit_gate_reduction_pct": {"mean": 20.0, "values": [10.0, 30.0]},
    "long_circuit_depth_reduction_pct": {"mean": 15.0, "values": [10.0, 20.0]},
...
_EMPTY_METRICS = {
    ...
    "long_circuit_gate_reduction_pct": {"mean": None, "values": []},
    "long_circuit_depth_reduction_pct": {"mean": None, "values": []},
